...
export default function Hero() {
  return (
    <section className="bg-gradient-to-r from-islamic-green-dark to-islamic-blue-dark text-islamic-white py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 font-arabic">أوقات الصلاة</h1>
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Accurate Prayer Times for Every Location</h2>
